...
$lista_app = trova_app_regola2($tipotariffa,$regole2,$num_regole2,$app_regola2_predef,$id_periodo_corrente,$idinizioperiodo,$idfineperiodo,$tipo_periodi,$anno,$tableregole);
...
if ($nuovaprenotazione) {
for ($n_t = 1 ; $n_t <= $num_tipologie ; $n_t++) {
if (${"appartamento".$n_t} and !${"assegnazioneapp".$n_t}) ${"assegnazioneapp".$n_t} = "k";
if (!${"lista_app".$n_t} and ${"assegnazioneapp".$n_t} != "k") {
echo "<input type=\"hidden\" name=\"num_piano$n_t\" value=\"".${"num_piano".$n_t}."\">
<input type=\"hidden\" name=\"num_casa$n_t\" value=\"".${"num_casa".$n_t}."\">
<input type=\"hidden\" name=\"num_persone_casa$n_t\" value=\"".${"num_persone_casa".$n_t}."\">";
} # fine if (!${"lista_app".$n_t} and ${"assegnazioneapp".$n_t} != "k")
} # fine for $n_t
$manda_dati_assegnazione = "SI";
include("./includes/dati_form_prenotazione.php");
} # fine if ($nuovaprenotazione)
...
if ($num_tipologie > 1) echo " ".mex("tipologia",$pag)." $n_t";
echo " <button type=\"button\" id=\"bott_cli$num1"."_$n_t\" onclick=\"apri_cli($n_t,$num1,$num_persone_tot)\">
