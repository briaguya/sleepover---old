...
esegui_query("insert into $tableprivilegi (idutente,anno,casse_consentite,priv_mod_pers,priv_ins_clienti,prefisso_clienti,priv_messaggi,priv_inventario) values ('$nuovo_id','1','n,','nnn','nnnss','n,','nn','nnnnnnnnn')");
...
$linee[$num_lin] = "\$tema[".$nuovo_id."] = \"sim\";
";
$num_lin++;
...
<input class=\"sbutton\" type=\"submit\" name=\"cont\" value=\"".mex("Modifica",$pag)."\">
