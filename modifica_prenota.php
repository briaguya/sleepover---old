...
if (tbox.value == '') {
";
if ($attiva_checkin == "SI") echo "var tcomm = document.getElementById('tcomm');
if (tcomm.value == '') ";
...
echo "<select id=\"tcomm\" class=\"smallsel\" name=\"tipo_commento\">
<option value=\"\"$sel_null>".mex("cambia in",$pag)."</option>";
...
<label><input type=\"checkbox\" name=\"n_cancella_commento\" value=\"SI\"$checked>
".mex("Cancella il commento",$pag).".</label>";
} # fine if ($priv_mod_commento == "s")
echo "</td></tr>";
