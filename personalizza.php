...
<input class=\"sbutton\" type=\"submit\" name=\"cambia_gest_cvc\" value=\"".mex("cambia",$pag)."\">";
...
<input class=\"sbutton\" type=\"submit\" value=\"".mex("Cancella le carte di credito di prenotazioni passate",'visualizza_tabelle.php')."\">
</div></form>";
...
closedir($lang_dir);
echo "<div style=\"line-height: 1.5em;\">$trad_lingue</div><div style=\"text-align: right; padding: 5px 0 0 0;\">
<input class=\"sbutton\" type=\"submit\" name=\"cambia_nome_unita_sing\" value=\"".mex("Cambia",$pag)."\"></div>";
} # fine if ($sel_pers)
else echo "<input class=\"sbutton\" type=\"submit\" name=\"cambia_nome_unita_sing\" value=\"".mex("Cambia",$pag)."\">";
...
echo "</select>
<input class=\"sbutton\" type=\"submit\" name=\"elimina_campo_pers_cliente\" value=\"".mex("elimina",$pag)."\">&nbsp;&nbsp;&nbsp;";
...
<input class=\"sbutton\" type=\"submit\" name=\"aggiungi_campo_pers_cliente\" value=\"".mex("aggiungi",$pag)."\">
</div></form><hr style=\"width: 95%\">";
...
echo "</td><td>
<input class=\"sbutton\" type=\"submit\" name=\"cambia_colori_tab_mesi\" value=\"".mex("cambia",$pag)."\">
</td></tr></table>
</div></form><hr style=\"width: 95%\">";
...
$sel_pop3_ssl = "";
$sel_imap_ssl = "";
if ($proto_email_tm == "imap") {
$sel_pop3 = "";
$sel_imap = " selected";
$sel_pop3_ssl = "";
$sel_imap_ssl = "";
} # fine if else if ($proto_email_tm == "imap")
if ($proto_email_tm == "pop3/ssl") {
$sel_pop3 = "";
$sel_imap = "";
$sel_pop3_ssl = " selected";
$sel_imap_ssl = "";
} # fine if else if ($proto_email_tm == "pop3/ssl")
if ($proto_email_tm == "imap/ssl") {
$sel_pop3 = "";
$sel_imap = "";
$sel_pop3_ssl = "";
$sel_imap_ssl = " selected";
} # fine if else if ($proto_email_tm == "imap/ssl")
...
<input type=\"text\" name=\"password_email_tm\" size=\"25\" value=\"$password_email_tm\">
 <small>(".mex("lasciare vuota per chiedere ogni volta",$pag).")</small></td></tr>
<tr><td valign=\"top\" style=\"text-align: right;\">".mex("Identificazione messaggi di richiesta",$pag).":</td><td>";
...
if ($num_trova_email_tm > 1) echo "<input class=\"sbutton\" type=\"submit\" name=\"eliminatrova_email_tm\" value=\"".mex("-",$pag)."\">&nbsp;";
echo "<input class=\"sbutton\" type=\"submit\" name=\"aggiungitrova_email_tm\" value=\"".mex("+",$pag)."\"></td></tr>
<tr><td></td><td><input class=\"sbutton\" type=\"submit\" value=\"".mex("Cambia",$pag)."\">
...
<input class=\"sbutton\" type=\"submit\" name=\"cambia_righe_messaggi\" value=\"".mex("Cambia",$pag)."\">
</div></form><hr style=\"width: 95%\">";
...
<input class=\"sbutton\" type=\"submit\" name=\"cambia_tot_giornalero_tab_casse\" value=\"".ucfirst(mex("cambia le righe",$pag))."\">
</div></form><hr style=\"width: 95%\">";
