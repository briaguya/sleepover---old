...
if (controlla_num($importa_percent) == "NO" or ($tipo_percent == "perc" and $importa_percent < -99)) $errore = "SI";
if ($errore != "SI") {
...
<input type=\"text\" name=\"importa_percent\" size=\"3\" maxlength=\"3\" value=\"0\"><select name=\"tipo_percent\" id=\"tip_per\" onchange=\"att_dis_arrotond()\"> 
