...
if (!$calcolabile_js['nessuno']) $onclick = " onclick=\"return moltiplica_costi_pv('$num1')\"";
echo "<div style=\"float: left; padding: 2px;\">
<button class=\"pos\" type=\"submit\" name=\"moltiplica\" value=\"$num1\"$onclick style=\"height: 60px; width: 64px;\"><b>X $num1</b></button>
</div>";
} # fine for $num1
echo "<div style=\"float: left; height: 64px; width: 8px;\">&nbsp;</div>";
for ($num1 = 1 ; $num1 <= 9 ; $num1++) {
if (!$calcolabile_js['nessuno']) $onclick = " onclick=\"return aggiungi_costi_pv('$num1')\"";
echo "<div style=\"float: left;\">
<button class=\"pos\" type=\"submit\" name=\"aggiungi\" value=\"$num1\"$onclick style=\"height: 60px; width: 64px; margin: 2px;\"><b>+ $num1</b></button>
</div>";
} # fine for $num1
if (!$calcolabile_js['nessuno']) $onclick = " onclick=\"return sottrai_costi_pv('1')\"";
echo "<div style=\"float: left; height: 64px; width: 8px;\">&nbsp;</div>
<div style=\"clear: right;\">
<button class=\"pos\" type=\"submit\" name=\"sottrai\" value=\"1\"$onclick style=\"height: 60px; width: 64px; margin: 2px;\"><b>- 1</b></button>
