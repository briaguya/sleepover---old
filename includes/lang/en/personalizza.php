...
case "Creazione automatica del nuovo anno disattivata (importando i data dall'anno precedente al primo login di un utente)":	$messaggio = "Automatic creation of new year disabled (importing data from previous year at the first login of any user)"; break;
case "Creazione automatica del nuovo anno attivata (importando i data dall'anno precedente al primo login di un utente)":	$messaggio = "Automatic creation of new year enabled (importing data from previous year at the first login of any user)"; break;
...
case "I data della struttura sono stati cambiati":	$messaggio = "Property data have been changed"; break;
...
case "Modifica i data della struttura":  	$messaggio = "Modify property data"; break;
...
case "password per la visualizzazione dei data delle carte di credito":	$messaggio = "password to view credit cards data"; break;
...
case "<b>Attenzione</b>: se si perde questa password non sarà più possibile leggere i data delle carte di credito inserite":	$messaggio = "<b>Warning</b>: if you lose this password you won't be able to read inserted credit cards data anymore"; break;
...
case "<b class=\"colred\">Attenzione</b>: tutti i data delle carte di credito verranno cancellati":	$messaggio = "<b class=\"colred\">Warning</b>: all credit cards data will be deleted"; break;
...
case "I data per lo scaricamento delle email sono sbagliati o incompleti":	$messaggio = "The data to download emails are wrong or incomplete"; break;
...
case "L'accettazione di questa clausola conferma che gli sviluppatori di questo software sono liberi da ogni responsibilità sulla sicurezza di questi data":	$messaggio = "Accepting this clause confirms that the developers of this software are free from all responsibilities regarding the security of these data"; break;
