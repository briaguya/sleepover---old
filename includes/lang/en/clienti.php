...
case "Inserisci i data di un nuovo cliente":  	$messaggio = "Insert a new client's data"; break;
...
case "Modifica i data del cliente":  		$messaggio = "Modify the data of client"; break;
...
case "I data del cliente":  			$messaggio = "The data of client"; break;
case "sono stati inseriti":  			$messaggio = "have been inserted"; break;
case "Inserisci o modifica i data di un cliente":	$messaggio = "Insert or modify a client's data"; break;
...
case "Inserisci i data":  			$messaggio = "Insert data"; break;
case "Torna al menù principale":  		$messaggio = "Back to main menu"; break;
case "Italia":  				$messaggio = ""; break;
case "non verrano modificati i data specifici delle 2 persone di riferimento":	$messaggio = "data specific to the 2 reference people will not be changed"; break;
...
case "I data di un costo aggiuntivo sono errati":	$messaggio = "Data from and extra cost is wrong"; break;
