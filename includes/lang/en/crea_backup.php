...
case "Inserisci i nuovi data per la connessione al database":	$messaggio = "Insert the new data to connect to the database"; break;
...
case "Non è stato possibile connettersi al nuovo database, controllare i data per la connessione, i privilegi dell' utente o il nome del database":	$messaggio = "It was not possible to connect to the new database, check connection data, the user privileges or the name of the database"; break;
case "Non è stato possibile creare il nuovo database, controllare i data per la connessione, i privilegi dell' utente, il nome del database o se esiste già un database chiamato":	$messaggio = "It was not possible to create the new database, check connection data, the user privileges, the name of the database or if already exists a database called"; break;
...
case "Ripristina i data dal file":  		$messaggio = "Restore data from file"; break;
case " (i data attuali verranno cancellati), utilizzando per la connessione al database:":	$messaggio = " (current data will be deleted), using for database creation:"; break;
case "i data dell'attuale connessione":  	$messaggio = "data of current connection"; break;
case "nuovi data":  				$messaggio = "new data"; break;
...
case "Prova a mantenere i data degli anni non contenuti nel backup":	$messaggio = "Try to retain data of years not contained in the backup"; break;
case "alcuni data di questi anni potrebbero comunque venir persi":	$messaggio = "some data of these years may be lost anyway"; break;
