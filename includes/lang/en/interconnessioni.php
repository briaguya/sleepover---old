...
case "Impossibile effettuare il collegamento, controllare i data immessi":	$messaggio = "Connection refused, check inserted data"; break;
case "Subordinazione cancellata":  		$messaggio = "Subordination deleted"; break;
case "Torna indietro":  			$messaggio = "Go back"; break;
case "Interconnessioni con sorgenti esterne di data":	$messaggio = "Interconnections with external data sources"; break;
...
case "Con la subordinazione non si potranno inserire nuovi data o apportare modifiche, ma solo importare i data dall'installazione principale":	$messaggio = "With subortdination you won't be able to insert new data or apply modifications, but only to import data from the master installation"; break;
...
case "Non ho i permassi di scrittura sulla cartella data":	$messaggio = "I don't have write premissions on data folder"; break;
case "Prova a mantenere i data degli anni non presenti nell'installazione remota":	$messaggio = "Try to retain data of years not present in remote installation"; break;
