...
case "Utilizza i data attuali per la connessione al database":	$messaggio = "Use current data to connect to the database"; break;
case "Utilizza altri data per la connessione al database":	$messaggio = "Use other data to connect to the database"; break;
...
case "Percorso alla directory data da dove verrà posizionato lo script":	$messaggio = "Path to \"data\" folder from where the script will be placed"; break;
