...
case "Inserisci le regole di assegnazione per le prenotazioni dell'anno":	$messaggio = "Inserta las reglas de asignación para las reservas del año"; break;
...
case "Inserisci la regola":  			$messaggio = "Inserta la regla"; break;
case "Inserisci o modifica la regola":  	$messaggio = "Inserta o modifica la regla"; break;
...
case "Vedi le regole già inserite":  		$messaggio = "Mira las reglas ya insertadas"; break;
case "Torna al menù principale":  		$messaggio = "Vuelve al menú principal"; break;
case "Non sono stati inseriti tutti i data necessari":	$messaggio = "No han sido insertados todos los datos necesarios"; break;
...
case "assegna automaticamente come numero di persone":	$messaggio = "asigna automaticamente como número de personas"; break;
