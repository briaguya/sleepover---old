...
case "Con la subordinazione non si potranno inserire nuovi data o apportare modifiche, ma solo importare i data dall'installazione principale":	$messaggio = "Con la subordinación no se podrán insertar nuevos datos y efectuar modificaciones, solo importar datos desde la instalación principal"; break;
...
case "Non ho i permassi di scrittura sulla cartella data":	$messaggio = "No tengo los permisos para escribir en el directorio data"; break;
case "Prova a mantenere i data degli anni non presenti nell'installazione remota":	$messaggio = "Intentar mantener los datos de los años no presentes en la instalación remota"; break;
