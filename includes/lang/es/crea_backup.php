...
case "Non è stato possibile connettersi al nuovo database, controllare i data per la connessione, i privilegi dell' utente o il nome del database":	$messaggio = "No ha sido posible conectarse a la nueva base de datos, controlar los datos de conexión, los privilejios del usuario o el nombre de la base de datos"; break;
case "Non è stato possibile creare il nuovo database, controllare i data per la connessione, i privilegi dell' utente, il nome del database o se esiste già un database chiamato":	$messaggio = "No ha sido posible crear la nueva base de datos, controlar los datos de conexión, los privilejios del usuario, el nombre de la base de datos o si ya existe una base de datos llamada"; break;
...
case "Ripristina i data dal file":  		$messaggio = "Restaurar los datos desde el archivo"; break;
case " (i data attuali verranno cancellati), utilizzando per la connessione al database:":	$messaggio = " (los datos actuales serán borrados), utilizando para la creación de la base de datos:"; break;
case "i data dell'attuale connessione":  	$messaggio = "los datos de la conexión actual"; break;
case "nuovi data":  				$messaggio = "nuevos datos"; break;
...
case "Prova a mantenere i data degli anni non contenuti nel backup":	$messaggio = "Intentar mantener los datos de los años no contenidos en el backup"; break;
case "alcuni data di questi anni potrebbero comunque venir persi":	$messaggio = "algunos datos de estos años se podrían perder igualmente"; break;
