...
<h5>".mext_rat("Pagina della tabella con le tariffe",$pag)."</h5><br><br>
...
<input class=\"sbutton\" type=\"submit\" value=\"".mext_rat("Crea la pagina con la tabella delle tariffe",$pag)."\">
</div></div></form><br>
