...
<h5>".mext_cal("Pagina del calendario della disponibilità",$pag)."</h5><br><br>
...
<input class=\"sbutton\" type=\"submit\" value=\"".mext_cal("Crea la pagina con il calendario della disponibilità",$pag)."\">
</div></div></form><br>
