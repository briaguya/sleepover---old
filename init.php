...
sleepover version ".C_PHP_VERSION_TXT.", Copyright (C) 2001-2015 Marco M. F. De Santis<br>
...
$colore = "";
if ($pagato < $costo_tot) {
$colore = "#FFEE22"; #giallo
if ($pagato < $caparra) $colore = "#FF9900"; #arancione
if ($confermato != "S") $colore = "#CC0000"; # rosso
...
if ($modifica_pers != "NO" or $priv_crea_backup == "s") {
...
} # fine if ($modifica_pers != "NO" or $priv_crea_backup == "s")
